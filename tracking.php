...
if(isset($_GET['id'])){
    ...
    if($status == 0){
        ...
        $apiUrl = 'https://mysmsuno.clairemontferrond.com/clairemont_mysms.php';
        $apiParams = [
            'number'   => '09951158967',
...
<head>
    ...
    <title>Laundry  customer textbased management System Tracking</title>
                    ...
                    <div class="card text-black card-stepper" style="border-radius:16px;">
                        <div class="card-body p-5">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <p class="mb-0">Laundry customer textbased management System</p>
                                    </div>
                                </div>
                            </div>

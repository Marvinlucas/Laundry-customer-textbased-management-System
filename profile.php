...
<head>
    ...
    <title>Profile - Laundry  customer textbased management System</title>
                                        ...
                                        <div class="card-body">
                                            <form action="functions/update-account.php" method="post">
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="email"><strong>Enter&nbsp;Password</strong></label><input class="form-control" type="password" placeholder="Current Password" name="current"></div>
                                                    </div>
                                                    <div class="col">
